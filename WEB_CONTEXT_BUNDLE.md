...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-alg-002-kaplansky-s-conjectures-86dd5663-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/ALG-002"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-alg-002-kaplansky-s-conjectures-86dd5663-v1",
      "problem_contract_sha256": "eb2386678ad21f35b757a02c3292b04b85ccde46a37a711e3399b1b5640cf9ad",
      "problem_id": "problem:um-alg-002-kaplansky-s-conjectures-86dd5663",
      "route_id": "route:um-alg-002-kaplansky-s-conjectures-86dd5663-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-alg-002-kaplansky-s-conjectures-86dd5663-source-fidelity-01",
      "graph_id": "graph:um-alg-002-kaplansky-s-conjectures-86dd5663-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-alg-002-kaplansky-s-conjectures-86dd5663-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-alg-002-kaplansky-s-conjectures-86dd5663-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "A set of conjectures about group rings: (1) Zero divisor conjecture: If $G$ is a torsion-free group and $K$ is a field, then $K[G]$ has no zero divisors. (2) Idempotent conjecture: The only idempotents in $K[G]$ are 0 and 1. (3) Unit conjecture: The only units in $\\mathbb{Z}[G]$ are of the form $\\pm g$ for $g \\in G$."
          },
          "statement_sha256": "ffc94b0c061eb7a2807d46a4a48bd948960ec15782d7e47b11857334083fd602"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-alg-002-kaplansky-s-conjectures-86dd5663-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-alg-002-kaplansky-s-conjectures-86dd5663-root",
      "route_id": "route:um-alg-002-kaplansky-s-conjectures-86dd5663-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-alg-002-64e5df5089dd",
        "url": "https://www.unsolvedmath.com/problems/ALG-002"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
